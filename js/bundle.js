...
function menuCards() {
  ...
  axios__WEBPACK_IMPORTED_MODULE_0___default().get('http://localhost:3000/menu').then(data => createCard(data));
...
function forms(formSelector, modalTimerId) {
  ...
  function bindPostData(form) {
    form.addEventListener('submit', e => {
      ...
      const json = JSON.stringify(Object.fromEntries(formData.entries())); // const json = JSON.stringify(object);
      // request.send(json);
...
function tabs(tabsSelector, tabsContentSelector, tabsParentSelector, activeClass) {
  ...
  const tabSlider = document.querySelector(".tabcontainer"); // const width = tabSlider.clientWidth;
...
/*!**********************!*\
  ...
  \**********************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _js_modules_calculator__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../js/modules/calculator */ "./js/modules/calculator.js");
...
/* harmony import */ var _js_modules_forms__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../js/modules/forms */ "./js/modules/forms.js");
/* harmony import */ var _js_modules_modal__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/modal */ "./js/modules/modal.js");
...
window.addEventListener('DOMContentLoaded', () => {
  const modalTimerId = setTimeout(() => (0,_js_modules_modal__WEBPACK_IMPORTED_MODULE_3__.openModal)('.modal', modalTimerId), 50000);
  (0,_js_modules_calculator__WEBPACK_IMPORTED_MODULE_0__["default"])();
